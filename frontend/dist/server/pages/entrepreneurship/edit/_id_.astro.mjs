...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Editar Emprendimiento", "subtitle": "Modifica los datos generales, ubicaci\xF3n o contacto de tu proyecto" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div id="wizard-container" class="h-[calc(100vh-64px)] bg-slate-50 p-4"> ${renderComponent($$result2, "BackButton", $$BackButton, { "href": "/entrepreneurship" })} <p class="text-center pt-20 text-slate-500">
