...
import { E as EntrepreneurshipWizard } from '../../chunks/EntrepreneurshipWizard_pvYkLNEN.mjs';
import { $ as $$BackButton } from '../../chunks/BackButton_qXsGqafz.mjs';
export { renderers } from '../../renderers.mjs';

const $$Create = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Crear Emprendimiento", "subtitle": "Registra la informaci\xF3n general de tu proyecto paso a paso" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="h-[calc(100vh-64px)] bg-slate-50 p-4"> ${renderComponent($$result2, "BackButton", $$BackButton, { "href": "/entrepreneurship" })} ${renderComponent($$result2, "EntrepreneurshipWizard", EntrepreneurshipWizard, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/jonat/Downloads/Proyecto_creatividad/frontend/src/components/EntrepreneurshipWizard", "client:component-export": "EntrepreneurshipWizard" })} </div> ` })}`;
