...
const $$Create = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "DashboardLayout", $$DashboardLayout, { "title": "Plan Econ\xF3mico", "subtitle": "Construye el an\xE1lisis financiero de tu emprendimiento" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="h-[calc(100vh-64px)] bg-[#FAFAFA] p-4"> ${renderComponent($$result2, "BackButton", $$BackButton, { "href": "/dashboard" })} ${renderComponent($$result2, "PlanCreationContainer", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "C:/Users/jonat/Downloads/Proyecto_creatividad/frontend/src/components/PlanCreationContainer", "client:component-export": "PlanCreationContainer" })} </div> ` })}`;
